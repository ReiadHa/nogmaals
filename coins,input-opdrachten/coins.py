# name of student: M.Riad Alhakim
# number of student:99054420
# purpose of program: muntjes rekenen   
# function of program:muntjes rekenen en laten zien welke muntjes heb je terug gegeven. 
# structure of program: variabls, if statement, while loop, if stat,else , append en format, elif , for loop en print.
